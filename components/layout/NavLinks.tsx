...
import { LayoutDashboard, LayoutGrid, User, ClipboardCheck, Target, CalendarDays, GraduationCap, FlaskConical, FileText, Download, ScrollText, Compass, Search, Layers } from 'lucide-react';
